...
class _QueueSheetState extends State<QueueSheet> {
            ...
            proxyDecorator:
              ...
              return Material(
                ...
                child: ScaleTransition(
                  scale:
                      animation.drive(Tween<double>(begin: 1.0, end: 1.05)),
                  child: child,
                ),
              );
            },
            ...
            itemBuilder: (context, index) {
              ...
              return Dismissible(
                ...
                onDismissed: (direction) {
                  setState(() {
                    audioHandler
                        .customAction('removeFromQueue', {'index': index});
                  });
                },
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.isTransparent) {
      return _buildReorderableList(context, queue, currentIndex, theme);
    }
      ...
      child: BackdropFilter(
        ...
        child: Column(
          children: [
            ...
            // The list
            Expanded(
              child: _buildReorderableList(context, queue, currentIndex, theme),
            ),
          ],
        ),
      ),
